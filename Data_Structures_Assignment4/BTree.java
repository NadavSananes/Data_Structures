...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<Object> deque = new ArrayDeque<Object>() ;
    ...
    public void insert(T value) {
        if (root == null) {
            ...
            //adding to the deque for backtracking function
            deque.add(false) ;
            deque.add(value) ;
